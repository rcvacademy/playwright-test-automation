...
test('Built-in locators', async({page}) => {
 ...
 //By Attribute
 await page.locator('[type="tel"]').fill("RCVAcademy@rcvacademy.com");

 //By classname
 await page.locator('.form-control').fill("RCVAcademy@rcvacademy.com");
 await page.locator('[class="btn btn-primary"]').click();

 //By tagname
  await page.locator('input').fill("rcvacademy");
